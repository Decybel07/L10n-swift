...
Pod::Spec.new do |spec|
  ...
  spec.description      = <<-DESC
    SwiftyLocalizable is a pod that adds easier localization support for your app
  ...
  spec.subspec 'Extension' do |extension|
    extension.dependency 'SwiftyLocalizable/Core'
    extension.source_files = 'Source/Extensions/**/*.swift'
  end
  
  spec.subspec 'IBInspectable' do |inspectable|
    inspectable.dependency 'SwiftyLocalizable/Core'
