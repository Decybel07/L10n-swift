...
class L10n_EnglishLanguage_Tests: XCTestCase {
    ...
    func testDefinedPlural() {
        ...
        XCTAssertEqual(key.l10n(args: 0, 2), "Zero apples")
        XCTAssertEqual(key.l10n(args: 1), "One apple")
        XCTAssertEqual(key.l10n(args: 2), "2 apples")
        XCTAssertEqual(key.l10n(args: 5), "5 apples")
        XCTAssertEqual(key.l10n(args: 124), "124 apples")
    }

    func testDefinedPlural_tooManyParameters() {
        let key = "numberOfApples"

        XCTAssertEqual(key.l10n(args: 0, 4, 3, 1), "Zero apples")
        XCTAssertEqual(key.l10n(args: 1, 23), "One apple")
        XCTAssertEqual(key.l10n(args: 2, 56), "2 apples")
        XCTAssertEqual(key.l10n(args: 5), "5 apples")
        XCTAssertEqual(key.l10n(args: 124), "124 apples")
    }
